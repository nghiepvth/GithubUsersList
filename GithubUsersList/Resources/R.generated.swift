...
struct R: Rswift.Validatable {
  ...
  struct storyboard {
    /// Storyboard `GithubUserListStoryboard`.
    static let githubUserListStoryboard = _R.storyboard.githubUserListStoryboard()
    /// Storyboard `LaunchScreen`.
    static let launchScreen = _R.storyboard.launchScreen()
    /// Storyboard `Splash`.
    static let splash = _R.storyboard.splash()
    /// Storyboard `UserDetailStoryBoard`.
    static let userDetailStoryBoard = _R.storyboard.userDetailStoryBoard()
    /// Storyboard `WebViewController`.
    static let webViewController = _R.storyboard.webViewController()

    #if os(iOS) || os(tvOS)
    /// `UIStoryboard(name: "GithubUserListStoryboard", bundle: ...)`
    static func githubUserListStoryboard(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.githubUserListStoryboard)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIStoryboard(name: "UserDetailStoryBoard", bundle: ...)`
    static func userDetailStoryBoard(_: Void = ()) -> UIKit.UIStoryboard {
      return UIKit.UIStoryboard(resource: R.storyboard.userDetailStoryBoard)
    }
    #endif
  ...
  struct reuseIdentifier {
    ...
    /// Reuse identifier `UserListCell`.
    static let userListCell: Rswift.ReuseIdentifier<UserListCell> = Rswift.ReuseIdentifier(identifier: "UserListCell")
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    static func validate() throws {
      #if os(iOS) || os(tvOS)
      try githubUserListStoryboard.validate()
      #endif
      #if os(iOS) || os(tvOS)
      ...
      #endif
      #if os(iOS) || os(tvOS)
      try userDetailStoryBoard.validate()
      #endif
      #if os(iOS) || os(tvOS)
    ...
    #if os(iOS) || os(tvOS)
    struct githubUserListStoryboard: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = GithubUserListViewController

      let bundle = R.hostingBundle
      let name = "GithubUserListStoryboard"
    ...
    #if os(iOS) || os(tvOS)
    struct userDetailStoryBoard: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      typealias InitialController = UserDetailViewController

      let bundle = R.hostingBundle
      let name = "UserDetailStoryBoard"
